...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            @can('users-create')
                <div class="mb-3">
                    <a href="{{route('admin.users.create')}}" class="btn btn-success mx-3 float-right font-weight-bold"><i class="fas fa-plus"></i> Add New</a>
                </div>
            @endcan
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">User Lists</h3>
    ...
    <div class="modal fade" id="users-delete-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="delete-users-btn"><i
...
@once
    @push('scripts')
        <script>
            ...
            $('#delete-users-btn').click(function (e) {
                e.preventDefault();
