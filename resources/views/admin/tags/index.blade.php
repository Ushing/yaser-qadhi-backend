...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
                <div class="mb-3">
                    <a href="#" data-size="lg" data-url="{{ route('admin.tag.create') }}" data-ajax-popup="true"
                       data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Tag')}}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Tag Lists</h3>
