    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.quran-recitation-list.edit',$quranRecitation->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Quran Recitation Edit</h3>
                            </div>
                            <form action="{{ route('admin.quran-recitation-list.update',$quranRecitation->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.quran-recitation-list.index')}}"
        ...
        <script type="text/javascript">
            ...
            let resumableVideoFile = new Resumable({
                target: '{{ route('admin.quran-recitation-list.upload.video') }}',
            ...
            let resumableAudioFile = new Resumable({
                target: '{{ route('admin.quran-recitation-list.upload.audio') }}',
                query: {_token: '{{ csrf_token() }}'},
