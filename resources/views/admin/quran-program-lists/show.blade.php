                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.quran_program_lists.show',$quranProgram->id)}}">show</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <audio class="ml-5" controls>
                                                    <source src="{{asset('uploads/quranProgram/audios/'.$quranProgram->audio)}}" type="audio/mp3">
                                                </audio>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <video class="ml-5" width="400" height="240" controls>
                                                    <source src="{{asset('uploads/quranProgram/videos/'.$quranProgram->video)}}" type="video/mp4">
                                                </video>
                                            </td>
                                        </tr>
                            ...
                            <div class="row">
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        @foreach ($quranProgramFiles as $file)
                                            <tr>
                                                <td>{{ $loop->index+1 }}</td>
                                                ...
                                                <td>
                                                    <div class="">
                                                        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.quranProgramFiles.edit',$file->id) }}"><i class="fa fa-edit"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
