                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.quran_program_lists.create')}}">Create</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Quran Program List</h3>
                            </div>
                            <form action="{{ route('admin.quran_program_lists.store') }}" method="post"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title"
                                                       ...
                                                       value="{{ old('title') }}" placeholder="Enter Quran Program Title" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select A Program Category <span
                                                        class="text-danger">*</span></label>
                                                <select
                                                    class="select2 form-control {{ $errors->has('quran_program_category_id') ? 'is-invalid' : '' }}"
                                                ...
                                                @if ($errors->has('quran_program_category_id'))
                                                    <div class="invalid-feedback">{{ $errors->first('quran_program_category_id') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
