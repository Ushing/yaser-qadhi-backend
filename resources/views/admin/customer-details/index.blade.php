                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.customer-detail.index')}}">Customers</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
{{--        <div class="row">--}}
{{--            <div class="mb-3">--}}
{{--                <a href="{{route('admin.customer.create')}}" class="btn btn-success mx-3 float-right font-weight-bold"><i class="fas fa-plus"></i> Add New</a>--}}
{{--            </div>--}}
{{--        </div>--}}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Customers</h3>
    ...
    <div class="modal fade" id="customer-delete-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="delete-customer-btn"><i
        ...
        <script>
            ...
            $('#delete-customer-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'admin/customer-detail/' + customerId,
                    dataType: 'JSON',
                    data: {
