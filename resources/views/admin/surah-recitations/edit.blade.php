                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.surah_recitations.edit',$surahRecitation->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="{{ route('admin.surah_recitations.update',$surahRecitation->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control {{ $errors->has('surah_id') ? 'is-invalid' : '' }}"
                                                        name="surah_id" id="surah_id" style="width: 100%">
                                                    <option value="">Choose Surah</option>
                                                    @foreach($surahs as $surah)
                                                        <option value="{{$surah->id}}"
                                                            {{ $surah->id == $surahRecitation->surah_id? 'selected' : ''}}>{{$surah->name_english}}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('surah_id'))
                                                    <div
                                                        class="invalid-feedback">{{ $errors->first('surah_id') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                       ...
                                                       value="{{ old('reference_id', $surahRecitation->reference_id) }}"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($surahRecitation->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($surahRecitation->status== '0') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Audio <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($surahRecitation->audio))
                                                    <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$surahRecitation->audio}}</span>
                                                ...
                                                <input id="uploadAudio" type="file" name ="audioFilename"
                                                       ...
                                                       value="{{ old('audio',$surahRecitation->audio )}}"
                                                       placeholder="Enter Audio" accept="audio/*">
                                                @if ($errors->has('audio'))
                                                    <div class="invalid-feedback">{{ $errors->first('audio') }}</div>
                                                @endif
                                            </div>
                                            <div class="progress progressAudioSection mt-3" style="height: 25px" id="surahAudioProgressBar">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Video <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($surahRecitation->video))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$surahRecitation->video}}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">Previous File Not Available:</span>
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('video',$surahRecitation->video )}}"
                                                       placeholder="Enter Video" accept="video/*">
                                                @if ($errors->has('video'))
                                                    <div class="invalid-feedback">{{ $errors->first('video') }}</div>
                                                @endif
                                            </div>
                                            <div class="progress progressVideoSection mt-3" style="height: 25px" id="surahVideoProgressBar">
