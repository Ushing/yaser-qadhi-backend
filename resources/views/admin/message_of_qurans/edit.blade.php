    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.message_of_qurans.edit',$message_of_qurans->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Message of Quran Edit</h3>
                            </div>
                            <form action="{{ route('admin.message_of_qurans.update',$message_of_qurans->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title',$message_of_qurans->title) }}" placeholder="" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                       ...
                                                       value="{{ old('reference_id', $message_of_qurans->reference_id) }}"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($message_of_qurans->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($message_of_qurans->status== '0') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($message_of_qurans->video))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$message_of_qurans->video}}</span>
                                                @else
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('video',$message_of_qurans->video )}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Audio <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($message_of_qurans->audio))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$message_of_qurans->video}}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">Previous File Not Available:</span>
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('audio',$message_of_qurans->audio)}}"
        ...
        <script type="text/javascript">
            ...
            let resumableVideoFile = new Resumable({
                target: '{{ route('admin.message_of_qurans.upload.video') }}',
            ...
            let resumableAudioFile = new Resumable({
                target: '{{ route('admin.message_of_qurans.upload.audio') }}',
                query: {_token: '{{ csrf_token() }}'},
