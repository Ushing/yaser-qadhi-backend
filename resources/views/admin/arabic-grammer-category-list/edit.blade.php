    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.arabic-grammer-category-list.edit',$arabicGrammarCategoryList->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Arabic Grammar Category List Edit</h3>
                            </div>
                            <form action="{{ route('admin.arabic-grammer-category-list.update',$arabicGrammarCategoryList->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title',$arabicGrammarCategoryList->title) }}" placeholder="" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-2 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelect1">Arabic Grammar<span class="text-danger">*</span></label>
                                                <select
                                                    class="form-control selectpicker {{ $errors->has('arabic_grammar_id') ? 'is-invalid' : '' }}"
                                                    name="arabic_grammar_id" id="arabic_grammar_id" data-size="5" data-live-search="true">

                                                    <option value="">Select Arabic Grammar</option>
                                                    @foreach ($arabicGrammar as $Arabic_grammar)
                                                        <option value="{{ $Arabic_grammar->id }}"
                                                            {{ $Arabic_grammar->arabic_grammar_id == $Arabic_grammar->id ? 'selected' : '' }}>
                                                            {{ $Arabic_grammar->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('arabic_grammar_id'))
                                                    <div class="invalid-feedback">{{ $errors->first('arabic_grammar_id') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                       ...
                                                       value="{{ old('reference_id', $arabicGrammarCategoryList->reference_id) }}"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($arabicGrammarCategoryList->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($arabicGrammarCategoryList->status== '0') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($arabicGrammarCategoryList->video))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$arabicGrammarCategoryList->video}}</span>
                                                @else
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('video',$arabicGrammarCategoryList->video )}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Audio <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($arabicGrammarCategoryList->audio))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$arabicGrammarCategoryList->video}}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">Previous File Not Available:</span>
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('audio',$arabicGrammarCategoryList->audio)}}"
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.arabic-grammer-category-list.index')}}"
        ...
        <script type="text/javascript">
            ...
            let resumableVideoFile = new Resumable({
                target: '{{ route('admin.arabic-grammer-category-list.upload.video') }}',
            ...
            let resumableAudioFile = new Resumable({
                target: '{{ route('admin.arabic-grammer-category-list.upload.audio') }}',
                query: {_token: '{{ csrf_token() }}'},
