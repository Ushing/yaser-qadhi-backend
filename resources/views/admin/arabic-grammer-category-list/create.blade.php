                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.arabic-grammer-category-list.create')}}">Create</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">{{\Illuminate\Support\Str::upper('arabic-grammer-category-list')}}</h3>
                            </div>
                            <form action="{{ route('admin.arabic-grammer-category-list.store') }}" method="post"
                                        ...
                                        <div class="col-sm-2 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="">Select a Arabic Grammar</option>
                                                    @foreach ($arabicGrammar as $Arabic_grammar)
                                                        <option value="{{ $Arabic_grammar->id }}"
                                                            {{ old('arabic_grammar_id') == $Arabic_grammar->id ? 'selected' : '' }}>
