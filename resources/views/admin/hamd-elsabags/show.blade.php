                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.hamd_elsabags.show',$hamdElsabag->id)}}">show</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <video class="ml-5" width="400" height="240" controls>
                                                    <source src="{{asset('uploads/hamdElsabags/videos/'.$hamdElsabag->video)}}" type="video/mp4">
                                                </video>
                                            </td>
                                        </tr>
                            ...
                            <div class="card-footer text-center">
                                <a class="btn btn-success bg-gradient-success mr-2" href="{{route('admin.hamd_elsabags.index')}}"> <i class="fas fa-backward"></i> Back To list</a>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                                        </thead>--}}
{{--                                        <tbody>--}}
{{--                                        @foreach ($hamdElsabagFiles as $file)--}}
{{--                                            <tr>--}}
{{--                                                <td>{{ $loop->index+1 }}</td>--}}
