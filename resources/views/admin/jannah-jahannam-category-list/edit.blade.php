                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.jannah-jahannam-category-list.edit',$arabicGrammarCategoryList->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Jannah Jahannan Category List Edit</h3>
                            </div>
                            <form action="{{ route('admin.jannah-jahannam-category-list.update',$arabicGrammarCategoryList->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="">Select Jannah and Jahannam ID</option>
                                                    @foreach ($arabicGrammar as $Arabic_grammar)
                                                        <option value="{{ $Arabic_grammar->id }}"
                                                            {{ $Arabic_grammar->jannah_and_jahannam_id == $Arabic_grammar->id ? 'selected' : '' }}>
