                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.yasir-lecture.edit',$yasirLecture->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="{{ route('admin.yasir-lecture.update',$yasirLecture->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title',$yasirLecture->title) }}" placeholder="" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="icon_image"
                                                    ...
                                                    value="{{ old('icon_image', $yasirLecture->icon_image) }}"
                                                    placeholder="Enter Icon Image">

                                                @if (isset($yasirLecture->icon_image))
                                                    <span class="text-black">{{ $yasirLecture->icon_image }}</span>
                                                @else
                                                ...
                                                @if (isset($yasirLecture->icon_image))
                                                    <img class="img-feature"
                                                        src="{{ asset('images/YasirQadhi/' . $yasirLecture->icon_image) }}" width="200">
                                                @else
                                                    No Thumbnail
                                                @endif
                                                <br><br>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="cover_image"
                                                    ...
                                                    value="{{ old('cover_image', $yasirLecture->cover_image) }}"
                                                    placeholder="Enter Icon Image">

                                                @if (isset($yasirLecture->cover_image))
                                                    <span class="text-black">{{ $yasirLecture->cover_image }}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">File Not
                                                        Available</span>
                                                @endif
                                                ...
                                                @if (isset($yasirLecture->cover_image))
                                                    <img class="img-feature"
                                                        src="{{ asset('images/YasirQadhi/' . $yasirLecture->cover_image) }}" width="200">
                                                @else
                                                    No Thumbnail
                                                @endif
                                                <br><br>
