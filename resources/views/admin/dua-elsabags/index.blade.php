                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.dua_elsabags.index')}}">Dua</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
{{--                    <a href="{{route('admin.lecture.order.view')}}" class="btn btn-info mx-3 float-right font-weight-bold"><i class="fas fa-refresh"></i> Short Order</a>--}}
                    <a href="{{route('admin.dua_elsabags.create')}}" class="btn btn-success mx-3 float-right font-weight-bold"><i class="fas fa-plus"></i> Add New</a>
                </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Dua</h3>
        ...
        <script>
            ...
            $('#delete-lecture-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'admin/dua_elsabags/' + surahId,
                    dataType: 'JSON',
                    data: {
                        'surahId': surahId,
                    },
