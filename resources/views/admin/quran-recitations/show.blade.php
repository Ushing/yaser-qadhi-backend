                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.quran_recitations.show',$quranRecitation->id)}}">show</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <video class="ml-5" width="400" height="240" controls>
                                                    <source src="{{asset('uploads/quranRecitations/videos/'.$quranRecitation->video)}}" type="video/mp4">
                                                </video>
                                            </td>
                                        </tr>
