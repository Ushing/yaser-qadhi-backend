                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.quran_recitations.edit',$quranRecitation->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="{{ route('admin.quran_recitations.update',$quranRecitation->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.quran_recitations.index')}}"
        ...
        @push('scripts')
            ...
            <script type="text/javascript">
                ...
                let resumableVideoFile = new Resumable({
                    target: '{{ route('admin.quran_recitations.upload.video') }}',
                ...
                let resumableAudioFile = new Resumable({
                    target: '{{ route('admin.quran_recitations.upload.audio') }}',
                    query: {_token: '{{ csrf_token() }}'},
