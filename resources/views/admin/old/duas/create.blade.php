...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.dua.create') }}">Create</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Dua Create</h3>
                            </div>
                            <form action="{{ route('admin.dua.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    value="{{ old('title') }}" placeholder="Enter Dua Title" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                    ...
                                                    value="{{ old('reference_id') }}" placeholder="Enter Dua Reference ID" />
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    class="select2 form-control {{ $errors->has('dua_category_id') ? 'is-invalid' : '' }}"
                                                    ...
                                                    @foreach ($duaCategories as $duaCategory)
                                                        <option value="{{ $duaCategory->id }}">{{ $duaCategory->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('dua_category_id'))
                                                    <div class="invalid-feedback">{{ $errors->first('dua_category_id') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Dua Sub Category <span
                                                        class="text-danger">*</span></label>
                                                <select
                                                    class="select2 form-control {{ $errors->has('status') ? 'is-invalid' : '' }}"
                                                    name="dua_sub_category_id" id="dua_sub_category_id" style="width: 100%">
                                                    <option value="">Choose Dua Sub Category</option>
                                                </select>
                                                @if ($errors->has('dua_sub_category_id'))
                                                    <div class="invalid-feedback">
                                                        {{ $errors->first('dua_sub_category_id') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="arabic_dua"
                                                    ...
                                                    placeholder="Enter Dua Translation">{{ old('arabic_dua') }}</textarea>
                                                @if ($errors->has('arabic_dua'))
                                                    <div class="invalid-feedback">{{ $errors->first('arabic_dua') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="uploadAudio" type="file" name="audioFilename"
                                                    ...
                                                    value="{{ old('audio') }}" placeholder="Enter Audio"
                                                    accept="audio/*">
                                                @if ($errors->has('audio'))
                                        ...
                                        <div class="col-sm-12 col-md-12" hidden>
                                            <div class="form-group">
                                                <label for="File">Lecture Audio <span
                                                        class="text-danger"></span></label>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                           {{--  <select
                                                class="select2 form-control {{ $errors->has('dua_category_id') ? 'is-invalid' : '' }}"
                                                name="dua_video" id="dua_video" style="width: 100%">
                                                <option value="">Choose Dua Video</option>
                                                @foreach ($dua as $duas)
                                                    <option value="{{ $duas->video }}">{{ $duas->video }}</option>
                                                @endforeach
                                            </select> --}}
                                        ...
                                        <div class="col-sm-12 col-md-12" hidden>
                                            <div class="form-group">
                                                <label for="File">Lecture Video <span
                                                        class="text-danger"></span></label>
    ...
    @once
        @push('scripts')
            ...
            <script>
                $(document).ready(function() {
                    let duaCategoryId = '{{ old('dua_category_id') }}'
                    let duaSubCategoryId = '{{ old('dua_sub_category_id') }}'
                    $('#dua_category_id').change(function() {
                        if ($(this).val() > 0) {
                            $.get('{{ route('admin.duaSubCategory.list.duaCategory') }}', {
                                duaCategoryId: $(this).val()
                            }, function(response) {
                                if (response.duaSubCategories) {
                                    $('#dua_sub_category_id').html(
                                        '<option value="">Choose Dua Sub Category</option>');
                                    for (i in response.duaSubCategories) {
                                        ...
                                        let selected = duaSubCategory.id == duaSubCategoryId ? 'selected' :
                                            '';
                                        $('#dua_sub_category_id').append('<option value="' + duaSubCategory
                                            .id + '" ' + selected + '>' + duaSubCategory.name +
                                            '</option>')
                                    }
                                }
                            });
