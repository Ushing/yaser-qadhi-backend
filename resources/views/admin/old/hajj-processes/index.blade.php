...
@section('content')
    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.hajj_processes.index')}}">Hajj Process</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="row">
                <div class="mb-3">
                    <a href="#" data-size="lg" data-url="{{ route('admin.hajj_processes.create') }}" data-ajax-popup="true"
                       data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Hajj Process')}}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Hajj Process</h3>
        ...
        <script>
            ...
            $('#delete-tag-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'admin/hajj_processes/' + tagId,
                    dataType: 'JSON',
                    data: {
                        'tagId': tagId,
                    },
