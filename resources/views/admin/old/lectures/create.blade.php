                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    class="select2 form-control {{ $errors->has('lecture_category_id') ? 'is-invalid' : '' }}"
                                                    ...
                                                    @foreach($lectureCategories as $lectureCategory)
                                                        <option
                                                            value="{{$lectureCategory->id}}">{{$lectureCategory->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Lecture Sub Category <span
                                                        class="text-danger">*</span></label>
                                                <select
