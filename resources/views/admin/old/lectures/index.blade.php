...
@section('content')
    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.lecture.index')}}">Lecture</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="row">
            @if(\Illuminate\Support\Facades\Auth::user()->can('lecture-create'))
                <div class="mb-3">
                    ...
                    <a href="{{route('admin.lecture.create')}}" class="btn btn-success mx-3 float-right font-weight-bold"><i class="fas fa-plus"></i> Add New</a>
                </div>
        ...
        <script>
            ...
            $('#delete-lecture-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'admin/lecture/' + lectureId,
                    dataType: 'JSON',
                    data: {
                        'lectureId': lectureId,
                    },
