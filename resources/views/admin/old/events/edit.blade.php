                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.event.edit',$event->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="Name">Details <span class="text-danger">*</span></label>
                                                <textarea type="text" name="event_details"
                                                          class="summernote form-control {{ $errors->has('event_details') ? 'is-invalid' : '' }}"
                                                          placeholder="Enter Event Details">{{ old('event_details',$event->event_details ) }}</textarea>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($event->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($event->status== '0') ? 'checked' : ''}}>
