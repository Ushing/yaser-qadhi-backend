...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            @if(\Illuminate\Support\Facades\Auth::user()->can('event-create'))
                <div class="mb-3">
                    <a href="{{route('admin.event.create')}}" class="btn btn-success mx-3 float-right font-weight-bold"><i class="fas fa-plus"></i> Add New</a>
                </div>
            @endif
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Event Lists</h3>
    ...
    <div class="modal fade" id="event-delete-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="delete-event-btn"><i
        ...
        <script>
            ...
            $('#delete-event-btn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'admin/event/' + eventId,
                    dataType: 'JSON',
                    data: {
                        'eventId': eventId,
                    },
