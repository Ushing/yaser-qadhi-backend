...
@section('content')
    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.subscription.index')}}">Subscription</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="row">
            @if(\Illuminate\Support\Facades\Auth::user()->can('subscription-create'))
                <div class="mb-3">
                    <a href="#" data-size="lg" data-url="{{ route('admin.subscription.create') }}" data-ajax-popup="true"
                       data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Subscription')}}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Subscription Lists</h3>
    ...
    <div class="modal fade" id="subscription-delete-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Delete This Subscription</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="delete-subscription-btn"><i
    ...
    @push('scripts')
        ...
        <script>
            $(document).on('click', '.btn-delete', function (e) {
                var duaCategoryId = $(this).data('subscription-id')
                $('#duaCategoryId').val(duaCategoryId);
                $('#subscription-delete-modal').modal('show');
            });

            $('#delete-subscription-btn').click(function (e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: baseUrl + 'admin/subscription/' + duaCategoryId,
                    dataType: 'JSON',
                    data: {
