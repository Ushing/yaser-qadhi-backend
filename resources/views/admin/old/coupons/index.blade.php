...
@section('content')
    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.coupon.index')}}">Coupon</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="row">
                <div class="mb-3">
                    <a href="#" data-size="lg" data-url="{{ route('admin.coupon.create') }}" data-ajax-popup="true"
                       data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Coupon')}}"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bolder">Coupon Lists</h3>
    ...
    <div class="modal fade" id="coupon-delete-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="delete-coupon-btn"><i
    ...
    @push('scripts')
        ...
        <script>
            $(document).on('click', '.btn-delete', function (e) {
                ...
                $('#coupon-delete-modal').modal('show');
            });

            $('#delete-coupon-btn').click(function (e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        $('#coupon-delete-modal').modal('hide');
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
