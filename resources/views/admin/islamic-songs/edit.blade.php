                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.islamic_songs.edit',$islamicSong->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="{{ route('admin.islamic_songs.update',$islamicSong->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title',$islamicSong->title) }}" placeholder="" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                       ...
                                                       value="{{ old('reference_id', $islamicSong->reference_id) }}"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($islamicSong->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($islamicSong->status== '0') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($islamicSong->audio))
                                                    <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$islamicSong->audio}}</span>
                                                ...
                                                <input id="uploadAudio" type="file" name ="audioFilename"
                                                       ...
                                                       value="{{ old('audio',$islamicSong->audio )}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Video <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($islamicSong->video))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$islamicSong->video}}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">Previous File Not Available:</span>
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('video',$islamicSong->video )}}"
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.islamic_songs.index')}}"
            ...
            @push('scripts')
                ...
                <script type="text/javascript">
                    ...
                    let resumableAudioFile = new Resumable({
                        target: '{{ route('admin.islamic_songs.upload.audio') }}',
                ...
                <script type="text/javascript">
                    ...
                    let resumableVideoFile = new Resumable({
                        target: '{{ route('admin.islamic_songs.upload.video') }}',
                        query:{_token:'{{ csrf_token() }}'} ,// CSRF token
