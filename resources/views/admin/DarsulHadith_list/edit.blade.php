    ...
    <div class="content">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.DarsulHadith_list.edit',$DarsulHadithlist->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="{{ route('admin.DarsulHadith_list.update',$DarsulHadithlist->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title',$DarsulHadithlist->title) }}" placeholder="" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                       ...
                                                       value="{{ old('reference_id', $DarsulHadithlist->reference_id) }}"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($DarsulHadithlist->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($DarsulHadithlist->status== '0') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($DarsulHadithlist->video))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$DarsulHadithlist->video}}</span>
                                                @else
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('video',$DarsulHadithlist->video )}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Audio <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($DarsulHadithlist->audio))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$DarsulHadithlist->video}}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">Previous File Not Available:</span>
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('audio',$DarsulHadithlist->audio)}}"
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.DarsulHadith_list.index')}}"
        ...
        <script type="text/javascript">
            ...
            let resumableVideoFile = new Resumable({
                target: '{{ route('admin.DarsulHadith_list.upload.video') }}',
            ...
            let resumableAudioFile = new Resumable({
                target: '{{ route('admin.DarsulHadith_list.upload.audio') }}',
                query: {_token: '{{ csrf_token() }}'},
