                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.yasir-lecture-category-list.create')}}">Create</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">{{\Illuminate\Support\Str::upper('yasir-lecture-category-list')}}</h3>
                            </div>
                            <form action="{{ route('admin.yasir-lecture-category-list.store') }}" method="post"
                                        ...
                                        <div class="col-sm-2 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="">Select a Yasir Lecture</option>
                                                    @foreach ($arabicGrammar as $Arabic_grammar)
                                                        <option value="{{ $Arabic_grammar->id }}"
                                                            {{ old('yasir_lecture_id') == $Arabic_grammar->id ? 'selected' : '' }}>
