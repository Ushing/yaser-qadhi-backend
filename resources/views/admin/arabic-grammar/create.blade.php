                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.arabic-grammar.create')}}">Create</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">{{\Illuminate\Support\Str::upper('arabic-grammar')}}</h3>
                            </div>
                            <form action="{{ route('admin.arabic-grammar.store') }}" method="post"
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.arabic-grammar.index')}}"
