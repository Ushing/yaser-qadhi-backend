                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.quran_interviews.edit',$quranInterview->id)}}">Edit</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Quran Interview Edit</h3>
                            </div>
                            <form action="{{ route('admin.quran_interviews.update',$quranInterview->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title',$quranInterview->title) }}" placeholder="" />
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="reference_id"
                                                       ...
                                                       value="{{ old('reference_id', $quranInterview->reference_id) }}"
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between w-50">
                                                    <div>
                                                        <input type="radio" id="active" name="status" value="1" {{($quranInterview->status== '1') ? 'checked' : ''}} >
                                                        <label for="active">Active</label><br>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="inactive" name="status" value="0" {{($quranInterview->status== '0') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                @if(isset($quranInterview->audio))
                                                    <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$quranInterview->audio}}</span>
                                                ...
                                                <input id="uploadAudio" type="file" name ="audioFilename"
                                                       ...
                                                       value="{{ old('audio',$quranInterview->audio )}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Select Video <span
                                                        class="text-danger"></span></label>
                                                <br>
                                                @if(isset($quranInterview->video))
                                                  <span class="text-info font-weight-bold">Old:</span>  <span class="text-black"> {{$quranInterview->video}}</span>
                                                @else
                                                    <span class="text-info font-weight-bold">Previous File Not Available:</span>
                                                ...
                                                <input id="upload" type="file" name = "filename"
                                                       ...
                                                       value="{{ old('video',$quranInterview->video )}}"
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.quran_interviews.index')}}"
            ...
            @push('scripts')
                ...
                <script type="text/javascript">
                    ...
                    let resumableAudioFile = new Resumable({
                        target: '{{ route('admin.quran_interviews.upload.audio') }}',
                ...
                <script type="text/javascript">
                    ...
                    let resumableVideoFile = new Resumable({
                        target: '{{ route('admin.quran_interviews.upload.video') }}',
                        query:{_token:'{{ csrf_token() }}'} ,// CSRF token
